        ...
        <section className="bg-card p-4 md:p-8 rounded-[var(--radius)] border border-border shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-pink-700">Selling Price (₦)</label>
                <input required value={price} onChange={e => setPrice(formatPriceInput(e.target.value))} type="text" placeholder="e.g. 3,500" className="w-full p-3 rounded-md border border-pink-200 bg-background text-sm font-bold" />
              </div>
            </div>
