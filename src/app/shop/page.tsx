    ...
    <div className="pt-8 pb-16 md:py-16">
      <div className="max-w-[1440px] mx-auto px-2 md:px-6">
        <header className="px-2 md:px-0 mb-4 md:mb-12 flex justify-between items-center flex-wrap gap-4">
          <div>
            <h1 className="text-2xl md:text-4xl font-bold mb-4">Our Collection</h1>
            <p className="text-xs md:text-base text-muted-foreground">Explore our range of premium African-inspired goods.</p>
          </div>
