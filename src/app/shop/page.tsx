            ...
            <div className="flex gap-2 w-full overflow-x-auto pb-2 custom-scrollbar flex-nowrap px-2 md:px-0" style={{ '--scrollbar-thumb': '#D48806' } as React.CSSProperties}>
              ...
              <div className="relative inline-flex items-center shrink-0">
                <select
                  ...
                  className="appearance-none w-[100px] md:w-[120px] pl-2 pr-5 py-1.5 md:pl-3 md:pr-7 md:py-2 text-[10px] md:text-sm rounded-md transition-colors whitespace-nowrap outline-none font-bold cursor-pointer uppercase text-ellipsis overflow-hidden bg-transparent text-slate-800 dark:text-slate-200 border border-border hover:bg-muted"
                >
