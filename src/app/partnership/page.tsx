...
export default function PartnershipPage() {
  ...
  const handleShare = () => {
    ...
    const currentReferralLink = `https://nomostores.com/?ref=${partnerData.referralCode}`;
      ...
      <div className={`min-h-[80vh] flex items-center justify-center py-12 px-2 md:px-4 transition-colors duration-300 ${isDarkMode ? 'bg-zinc-950' : 'bg-slate-50'}`}>
        ...
        <div className={`max-w-4xl w-full rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2 animate-in fade-in slide-in-from-bottom-8 ${isDarkMode ? 'bg-zinc-900 border border-zinc-800 shadow-black/50' : 'bg-white border border-border'}`}>
          <div className="px-6 py-8 md:p-14 flex flex-col justify-center">
            <h1 className={`text-3xl md:text-4xl font-black mb-6 leading-tight ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
              ...
              <div className={`flex-1 w-full min-w-0 p-4 rounded-xl border flex flex-col justify-center overflow-hidden ${isDarkMode ? 'bg-zinc-950 border-zinc-800' : 'bg-slate-50 border-slate-200'}`}>
                ...
                <div className="w-full overflow-hidden">
                  <p className={`text-sm font-medium truncate w-full block ${isDarkMode ? 'text-zinc-400' : 'text-slate-600'}`}>
                    {`https://nomostores.com/?ref=${partnerData.referralCode}`}
                  </p>
                </div>
              </div>
