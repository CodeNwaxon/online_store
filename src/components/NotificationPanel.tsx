                    ...
                    <div className="flex justify-between items-start gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded ${notif.type === 'broadcast' ? 'bg-blue-100 text-blue-700' : notif.type === 'order' ? 'bg-green-100 text-green-700' : 'bg-muted text-muted-foreground'}`}>
